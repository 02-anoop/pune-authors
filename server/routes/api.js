...
router.get('/api/author/dashboard-data', verifyToken, async (req, res) => {
  ...
  try {
    ...
    const result = { authorProfile, authorOrders, dynamicFields, eventInvites, listedBooks, posOrders, notifications, activeDonations, totalWebAndBulkSales, totalWebSales, totalBulkSales, authorScatterData };
